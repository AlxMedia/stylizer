...
if ( ! function_exists( 'stylizer_styles' ) ) {
	...
	function stylizer_styles() {
		...
		wp_enqueue_style( 'stylizer-responsive', get_template_directory_uri().'/responsive.css' );
...
/* ------------------------------------ */
function stylizer_kirki_config( $config ) {
...
add_filter( 'kirki/config', 'stylizer_kirki_config', 999 );