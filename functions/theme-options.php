...
Kirki::add_section( 'reviewlink', array(
	...
	'button_url'  => 'https://wordpress.org/support/theme/stylizer/reviews/?filter=5#new-post',
	'priority'    => 1,
) );
...
Kirki::add_field( 'stylizer_theme', array(
	'type'			=> 'switch',
	'settings'		=> 'responsive',
	'label'			=> esc_html__( 'Responsive Layout', 'stylizer' ),
	'description'	=> esc_html__( 'Mobile and tablet optimizations (responsive.css)', 'stylizer' ),
	'section'		=> 'general',
	'default'		=> 'on',
) );
...
Kirki::add_field( 'stylizer_theme', array(
	...
	'section'		=> 'social',
	'tooltip'		=> esc_html__( 'Font Awesome names:', 'stylizer' ) . ' <a href="https://fontawesome.com/v4.7.0/icons/" target="_blank"><strong>' . esc_html__( 'View All', 'stylizer' ) . ' </strong></a>',
	'row_label'		=> array(
		'type'	=> 'text',
	...
	'fields'		=> array(
		...
		'social-icon'	=> array(
			...
			'description'	=> esc_html__( 'Font Awesome icons. Ex: fa-facebook ', 'stylizer' ) . ' <a href="https://fontawesome.com/v4.7.0/icons/" target="_blank"><strong>' . esc_html__( 'View All', 'stylizer' ) . ' </strong></a>',
			'default'		=> 'fa-',
		),
		'social-link'	=> array(
			'type'			=> 'link',
